...
variable "engine" {
  description = "The database engine to use. If not specified, will default to postgres. Possible value: aurora (for MySQL 5.6-compatible Aurora), aurora-mysql (for MySQL 5.7-compatible Aurora), aurora-postgresql, mariadb, mysql, oracle-ee, oracle-ee-cdb, oracle-se2, oracle-se2-cdb, postgres, sqlserver-ee, sqlserver-se, sqlserver-ex, sqlserver-web. Read more: https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstance.html"
  type        = string
  default     = "postgres"
}

variable "engine_version" {
  description = "The engine version to use. Default postgres engine version is 11.6. Read more: https://docs.aws.amazon.com/AmazonRDS/latest/APIReference/API_CreateDBInstance.html"
  type        = string
  default     = null
}
...
variable "maintenance_window" {
  description = "The window to perform maintenance in. Default is Monday 03:00 - 04:00. Syntax: 'ddd:hh24:mi-ddd:hh24:mi'. Eg: 'Mon:00:00-Mon:03:00'"
  type        = string
