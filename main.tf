module "rds" {
  ...
  db_subnet_group_name            = data.terraform_remote_state.central-vpc.outputs.private_subnet_group_id
  ...
  subnet_ids                      = data.terraform_remote_state.central-vpc.outputs.private_subnets
